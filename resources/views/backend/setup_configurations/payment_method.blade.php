    ...
    <div class="row">
      ...
      <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6 ">{{translate('fawaterk')}}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        <input type="hidden" name="payment_method" value="FAWATERK_KEY">
                        @csrf
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="FAWATERK_KEY">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('KEY')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="FAWATERK_KEY" value="{{  env('FAWATERK_KEY') }}" placeholder="{{ translate('KEY') }}" required>
                            </div>
                        </div>
